                    ...
                    <section className="container-regular">
                        ...
                        <div className="container-gray-dark rounded p-5 md:p-10 shadow">
                            <p className="mb-2">
                                ...
                                <code>
                                    <a href="https://theme.thedynamics.tech">
                                        linked code
                                    </a>
                                </code>{" "}
                                &{" "}
                                ...
                                . The paragraph ended up being 1 sentence, but
                                now I guess it’s <b>two</b>.
                            </p>
                            <pre>
                                Here's a code block! No highlighting to be
                                found.
                            </pre>
                        </div>
                    </section>
                    ...
                    <section className="container-regular" id="font-sizes">
                        ...
                        <div className="md:flex flex-col">
                            <div className="flex flex-wrap md:flex-nowrap items-baseline leading-[170px]">
                                <div className="inline-block truncate text-198px">
                                    198px
                                </div>
                                <div className="inline-block truncate text-156px">
                                    156px
                                </div>
                            </div>
                            <div className="flex flex-wrap md:flex-nowrap gap-2 md:ml-5 items-baseline leading-[170px]">
                                <div className="inline-block truncate text-120px">
                                    120px
                                </div>
                                <div className="inline-block truncate text-96px">
                                    96px
                                </div>
                                <div className="inline-block truncate text-90px">
                                    90px
                                </div>
                                <div className="inline-block truncate text-84px">
                                    84px
                                </div>
                                <div className="inline-block truncate text-78px">
                                    78px
                                </div>
                            </div>
                            <div className="flex flex-wrap md:flex-nowrap gap-2 md:ml-9 items-baseline leading-none">
                                <div className="inline-block truncate text-72px">
                                    72px
                                </div>
                                <div className="inline-block truncate text-66px">
                                    66px
                                </div>
                                <div className="inline-block truncate text-60px">
                                    60px
                                </div>
                                <div className="inline-block truncate text-54px">
                                    54px
                                </div>
                                <div className="inline-block truncate text-48px">
                                    48px
                                </div>
                                <div className="inline-block truncate text-42px">
                                    42px
                                </div>
                                <div className="inline-block truncate text-36px">
                                    36px
                                </div>
                                <div className="inline-block truncate text-30px">
                                    30px
                                </div>
                                <div className="inline-block truncate text-24px">
                                    24px
                                </div>
                                <div className="inline-block truncate text-18px">
                                    18px
                                </div>
                                <div className="inline-block truncate text-16px">
                                    16px
                                </div>
                                <div className="inline-block truncate text-15px">
                                    15px
                                </div>
                                <div className="inline-block truncate text-12px">
                                    12px
                                </div>
                            </div>
                        </div>
