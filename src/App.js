        ...
        <div className="flex flex-col sm:gap-1.5 md:gap-1.5 md:gap-10">
          ...
          <section className="container-regular">
            ...
            <div className="container-gray-dark rounded p-5 md:p-10 shadow">
              <p className="mb-2">
                This is a whole paragraph of text, include <code>code like this</code>, as well as{" "}
                <code>
                  <a href="https://theme.thedynamics.tech">linked code</a>
                </code>{" "}
                & <a href="https://theme.thedynamics.tech">regular links</a>. The paragraph ended up
                being 1 sentence, but now I guess it’s <b>two</b>.
              </p>
